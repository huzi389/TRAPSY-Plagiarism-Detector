...
def cosineSimilarityFunc():
	try:
		...
		matchPercent = (float)(dotProduct / (queryVectorMagnitude * databaseVectorMagnitude))*100
		...
		output = "Input query text matches %0.02f%% with database."%matchPercent
